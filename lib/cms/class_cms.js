...
class CMS {
  ...
  p_name = "";
  p_interpolationSpace = "lab";
  p_interpolationType = "linear"; // linear or spline or optimization
  p_colorNaN = { space: "rgb", c1: 0, c2: 0, c3: 0 };
  p_colorBelow = { space: "rgb", c1: 0, c2: 0, c3: 0 };
  p_colorAbove = { space: "rgb", c1: 0, c2: 0, c3: 0 };
  p_keys = [];
  p_deltaColors = [];
  p_jnd = 1; // just noticeable difference
  /// Probes
  p_probeSetArray = [];
  /// work
  p_workOn = false; // let some functions know that another method work on the CMS and not all guardian clauses are nessesarry or rather obstructive
