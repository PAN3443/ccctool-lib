          ...
          if (this.#deltaColors[_bandID].length > 0) {
            ...
            switch (index) {
              case 0:
                ...
                deltaColor_V2 = colorToVector(updateColorToSpace(this.#deltaColors[_bandID][index][0], space[1]));
                ratio = getRatio(this.#keys[_bandID].getRef(), this.#deltaColors[_bandID][index][1], _val);
                break;
              case 0:
                deltaColor_V1 = colorToVector(updateColorToSpace(this.#deltaColors[_bandID][index][0], space[1]));
