...
class CMS {
   ...
   **************************************************************************************************
   *************************************************************************************************/
  drawHorizontal(_width, _height, _colorBlind) {
    ...
    for (let i = 0; i < this.getKeyLength() - 1; i++) {
      ...
      switch (this.getKeyType(i)) {
        case "nil key":
        case "left key":
          createConstantBand(cmsImg, linearKey_xPos, 0, elementwidth, _height, this.getLeftKeyColor(i + 1, this.getInterpolationSpace()), _width);
          break;
        default:
          ////////////  Draw a Scaled Band ////////////////
          createScaledBand(cmsImg, linearKey_xPos, 0, elementwidth, _height, this.getRightKeyColor(i, this.getInterpolationSpace()), this.getLeftKeyColor(i + 1, this.getInterpolationSpace()), _width);
      }
    }
    return cmsImg;
  }

  drawBand(_imgRef, _xStart, _yStart, _bandID, _bandWidth, _bandHeight, _doColorBlind, _alpha) {
