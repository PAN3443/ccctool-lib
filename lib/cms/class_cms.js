    ...
    switch (_index) {
      ...
      default:
        ...
        /*if (this.interpolationType === "spline") {
          if (_index - 2 >= 0) {
            if (this.#keys[_index - 1].getKeyType() === "dual") {
              this._updateBandDeltaColors(_index - 2);
              if (_index - 3 >= 0) {
                if (this.#keys[_index - 2].getKeyType() === "dual") this._updateBandDeltaColors(index - 3);
              }
            }
          }
        }*/
      ...
      default:
        ...
        /*if (this.interpolationType === "spline") {
          if (index + 1 < this.getKeyLength()) {
            if (this.#keys[index + 1].getKeyType() === "dual") {
              this._updateBandDeltaColors(index + 1);
              if (index + 2 < this.getKeyLength()) {
                if (this.#keys[index + 2].getKeyType() === "dual") this._updateBandDeltaColors(index + 2);
              }
            }
          }
        }*/
