...
class CMS {
  ...
  parser_XML(_xmlCMS) {
    ...
    /*let probesetObjects = _xmlCMS.getElementsByTagName("ProbeSet");
    ...
    if (_xmlCMS.hasAttribute("name")) this.setCMSName(_xmlCMS.getAttribute("name"));

    if (_xmlCMS.hasAttribute("interpolationspace")) this.setInterpolationSpace(_xmlCMS.getAttribute("interpolationspace"));

    if (_xmlCMS.getElementsByTagName("NaN").length != 0) {
      let nanObj = _xmlCMS.getElementsByTagName("NaN");
    ...
    if (_xmlCMS.getElementsByTagName("Above").length != 0) {
      let aboveObj = _xmlCMS.getElementsByTagName("Above");
    ...
    if (_xmlCMS.getElementsByTagName("Below").length != 0) {
      let belowObj = _xmlCMS.getElementsByTagName("Below");
