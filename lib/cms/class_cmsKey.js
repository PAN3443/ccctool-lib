...
const { isColorJSON, isNumber, isCMSKey, isJSONEmpty } = require("../helper/guardClauses.js");
...
class KeyCMS {
  ...
  setCL(_cJSON_L) {
    if (isJSONEmpty(_cJSON_L)) _cJSON_L = undefined; // we need this because with stingify json during the export undefined varialbes will be saved as {}
  ...
  setCR(_cJSON_R) {
    if (isJSONEmpty(_cJSON_R)) _cJSON_R = undefined;
