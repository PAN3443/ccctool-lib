...
const { isMathVector_3D, isNumber, numInRange } = require("../helper/guardClauses.js");
const { vec_Diff, vec_Add, vecScalMulti } = require("../helper/math.js");
 ...
 **************************************************************************************************
 *************************************************************************************************/
exports.linearInterpolation = (_start, _end, _ratio) => {
...
/**************************************************************************************************
 **************************************************************************************************
 *  Function    : exports.linearInterpolation = (_start, _end, _ratio) => {
 *  Description : Implementation of the CATMULL ROM Splines
 **************************************************************************************************
 *************************************************************************************************/

exports.splineInterpolation = (v0, v1, v2, v3, t_val, curvescale) => {
