...
exports.vecNorm = (_v) => {
  let result = copyVector(_v);
  if (this.vecLength(_v) != 0) {
    let tmp = 1 / this.vecLength(_v);
    for (let i = 0; i < result.length; i++) {
...
exports.getRatio = (_min, _max, _value) => {
  ...
  if (!isNumber(_value)) throw new TypeError('Error (math) :: exports."getRatio" :: Incorrect input! The parameter "value" need be a number');
