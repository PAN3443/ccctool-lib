...
exports.checkMathResult = (shouldVal, isVal) => {
  ...
  if (Math.abs(shouldVal - isVal) < math_error) return true;
  return false;
};
...
exports.checkColorInput = (space, c1, c2, c3) => {
  ...
  if (space.length != 3) return false;
  if (!this.checkColorSpaceNotation(space)[0]) return false;
...
exports.checkColorSpaceNotation = (space, allowSpecial, allowCB) => {
