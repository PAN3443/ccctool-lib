  ...
  for (let i = 0; i < _cmsJSON.keys.length; i++) {
    ...
    switch (i) {
      case 0:
        ...
        } else if (_cmsJSON.keys[i].cL != undefined) return false; // start key is nil or right key, both have a undefined left key color
        break;
      case lastIndex:
        ...
        } else if (_cmsJSON.keys[i].cR != undefined) return false; // end key is left key (=> undefined right key color)
        if (this.isColorJSON(_cmsJSON.keys[i].cL)) {
          if (_cmsJSON.keys[i].cL.space === undefined || _cmsJSON.keys[i].cL.c1 === undefined || _cmsJSON.keys[i].cL.c2 === undefined || _cmsJSON.keys[i].cL.c3 === undefined) return false;
        } else if (_cmsJSON.keys[i].cL === undefined) return false; // end key is left key (=> defined left key color)
        break;
      default:
        if (this.isColorJSON(_cmsJSON.keys[i].cL)) {
          if (_cmsJSON.keys[i].cL.space === undefined || _cmsJSON.keys[i].cL.c1 === undefined || _cmsJSON.keys[i].cL.c2 === undefined || _cmsJSON.keys[i].cL.c3 === undefined) return false;
        } else if (_cmsJSON.keys[i].cL === undefined) return false; // only the start keys are allowed to have a undefined left color.
        break;
    }
  }
