...
class Color {
  ...
  changeColorSpace(_space) {
    ...
    let newColorJson = convertColorRecursiv({ space: this.#space, c1: this.#c1, c2: this.#c2, c3: this.#c3 }, space[1], false);
    this.#space = newColorJson.space;
    this.#c1 = newColorJson.c1;
    this.#c2 = newColorJson.c2;
    this.#c3 = newColorJson.c3;
  }
  ...
  getColorJSON(_wishColor, _convertProperties) {
    ...
    if (_wishColor == undefined) _wishColor = this.#space; // if no wishColor is set we use the #space propertie of this class. If the wishcolor is set and wrong => throw error
    ...
    return convertColorRecursiv({ space: this.#space, c1: this.#c1, c2: this.#c2, c3: this.#c3 }, _wishColor, false);
  }
    ...
    case "rgb":
      switch (_wishColor) {
        case "rgb":
          return _colorJSON;
        case "rgb_cb":
          if (_isCB) return _colorJSON; // if not => default
        default:
        case "hsv":
