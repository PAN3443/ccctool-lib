...
test("Color Class :: resetConvertProperties :: Test Convert Properties", () => {
  ...
  expect(json.DIN99KE).toBe(cccToolProperties.DIN99KE);
  expect(json.DIN99KCH).toBe(cccToolProperties.DIN99KCH);
  expect(json.REFX).toBe(cccToolProperties.REFX);
  expect(json.REFY).toBe(cccToolProperties.REFY);
  expect(json.REFZ).toBe(cccToolProperties.REFZ);
});
