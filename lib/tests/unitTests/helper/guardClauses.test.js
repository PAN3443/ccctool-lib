...
test("Color Class :: isMathVector :: Incorrect Input. (Undefined)", () => {
  expect(() => {
    guardClauses.isMathMatrix();
  }).toThrow();
});

test("Color Class :: isMathVector :: Incorrect Input. (Empty Array)", () => {
  expect(() => {
    guardClauses.isMathMatrix([]);
  }).toThrow();
});

test("Color Class :: isMathVector :: Correct Input.", () => {
  expect(() => {
    guardClauses.isMathMatrix([3, 5, 7]);
  }).toThrow();
});

test("Color Class :: isMathVector :: Incorrect Input. (Empty is NaN)", () => {
  expect(() => {
    guardClauses.isMathMatrix([3, NaN, undefined, "string"]);
  }).toThrow();
});
...
test("Color Class :: isMathMatrix :: Incorrect Input. (Undefined)", () => {
  expect(() => {
    guardClauses.isMathMatrix();
  }).toThrow();
});

test("Color Class :: isMathMatrix :: Incorrect Input. (Empty Array)", () => {
  expect(() => {
...
test("Color Class :: isMathMatrix :: Incorrect Input. (Different Row lengths)", () => {
  expect(() => {
    guardClauses.isMathMatrix([[2, 2], [2]], false);
  }).toThrow();
});

test("Color Class :: isMathMatrix :: Incorrect Input. (Number of rows is different to row lengths. equalColRowSize is true)", () => {
  expect(() => {
    guardClauses.isMathMatrix(
      [
        [2, 2],
...
test("Color Class :: isMathMatrix :: Correct Input. (equalColRowSize is false)", () => {
...
test("Color Class :: isMathMatrix :: Correct Input. (equalColRowSize is true)", () => {
  let result = guardClauses.isMathMatrix(
    [
      [2, 2],
      [2, 5],
...
test("Color Class :: isMathMatrix :: Incorrect Input. (Entry is NaN)", () => {
  expect(() => {
    guardClauses.isMathMatrix(
      [
        [2, NaN],
...
test("Guard Clauses :: isString :: Input is Not Colorspace String", () => {
  let result = guardClauses.checkColorSpaceNotation("test", true, true);
  expect(result[0]).toBe(false);
});

test("Guard Clauses :: isString :: Input is Number", () => {
  let result = guardClauses.checkColorSpaceNotation(3.212, true, true);
  expect(result[0]).toBe(false);
});

test("Guard Clauses :: isString :: Input is Undefined", () => {
  let result = guardClauses.checkColorSpaceNotation(undefined, true, true);
  expect(result[0]).toBe(false);
...
test("Guard Clauses :: checkColorSpaceNotation :: Input is Null", () => {
  let result = guardClauses.checkColorSpaceNotation(null, true, true);
  expect(result[0]).toBe(false);
});

///////////////// check normal colorspace notation /////////////////////
test('Guard Clauses :: isString :: Input is "HSV"', () => {
  let result = guardClauses.checkColorSpaceNotation("HSV", true, true);
...
test('Guard Clauses :: isString :: Input is "hsv_cb"', () => {
  let result = guardClauses.checkColorSpaceNotation("hsv_cb", true, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("hsv");
});
...
test('Guard Clauses :: isString :: Input is "RGB"', () => {
  let result = guardClauses.checkColorSpaceNotation("RGB", true, true);
  expect(result[0]).toBe(true);
...
test('Guard Clauses :: isString :: Input is ("rgb_cb", true, false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb", true, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});
...
test('Guard Clauses :: isString :: Input is ("rgb_255", false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_255", false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is "rgb_255"', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_255");
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb_255");
});

test('Guard Clauses :: isString :: Input is "rgb_cb_255"', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_255");
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb_cb_255");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_255", false, true)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_255", false, true);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_255", true, false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_255", true, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_255",false,false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_255", false, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is ("rgb_hex", false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_hex", false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is "rgb_hex"', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_hex");
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb_hex");
});

test('Guard Clauses :: isString :: Input is "rgb_cb_hex"', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_hex");
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb_cb_hex");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_hex", false, true)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_hex", false, true);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_hex", true, false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_hex", true, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_hex",false,false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_hex", false, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is ("rgb_string", false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_string", false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is "rgb_string"', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_string");
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb_string");
});

test('Guard Clauses :: isString :: Input is "rgb_cb_string"', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_string");
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb_cb_string");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_string", false, true)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_string", false, true);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_string", true, false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_string", true, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is ("rgb_cb_string",false,false)', () => {
  let result = guardClauses.checkColorSpaceNotation("rgb_cb_string", false, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("rgb");
});

test('Guard Clauses :: isString :: Input is "XYZ"', () => {
  let result = guardClauses.checkColorSpaceNotation("XYZ", true, true);
  expect(result[0]).toBe(true);
...
test('Guard Clauses :: isString :: Input is "xyz_cb"', () => {
  let result = guardClauses.checkColorSpaceNotation("xyz_cb", true, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("xyz");
});
...
test('Guard Clauses :: isString :: Input is "LMS"', () => {
  let result = guardClauses.checkColorSpaceNotation("LMS", true, true);
  expect(result[0]).toBe(true);
...
test('Guard Clauses :: isString :: Input is "lms_cb"', () => {
  let result = guardClauses.checkColorSpaceNotation("lms_cb", true, false);
  expect(result[0]).toBe(true);
  expect(result[1]).toEqual("lms");
});
